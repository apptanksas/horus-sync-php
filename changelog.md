...
## v0.1.5
- Se agrega notificacion a packagist cuando se realiza un release en github.
- Se modifica el workflow de tag releases para crear automaticamente el release en github.
